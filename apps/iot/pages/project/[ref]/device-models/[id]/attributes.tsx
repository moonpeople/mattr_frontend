...
const DeviceModelAttributesPage: NextPageWithLayout = () => {
  const { id } = useParams()
  ...
  return <DeviceModelEditorTabs modelId={modelId} activeStep={1} />
}

DeviceModelAttributesPage.getLayout = (page) => (
  <DefaultLayout>
    <DeviceModelLayout>{page}</DeviceModelLayout>
  </DefaultLayout>
)

export default DeviceModelAttributesPage
