...
const DeviceModelAlertsPage: NextPageWithLayout = () => {
  const { id } = useParams()
  ...
  return <DeviceModelEditorTabs modelId={modelId} activeStep={4} />
}

DeviceModelAlertsPage.getLayout = (page) => (
  <DefaultLayout>
    <DeviceModelLayout>{page}</DeviceModelLayout>
  </DefaultLayout>
)

export default DeviceModelAlertsPage
