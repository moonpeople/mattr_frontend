...
const DeviceModelInitializationPage: NextPageWithLayout = () => {
  const { id } = useParams()
  ...
  return <DeviceModelEditorTabs modelId={modelId} activeStep={5} />
}

DeviceModelInitializationPage.getLayout = (page) => (
  <DefaultLayout>
    <DeviceModelLayout>{page}</DeviceModelLayout>
  </DefaultLayout>
)

export default DeviceModelInitializationPage
