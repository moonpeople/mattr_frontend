...
const DeviceModelMessagesPage: NextPageWithLayout = () => {
  const { id } = useParams()
  ...
  return <DeviceModelEditorTabs modelId={modelId} activeStep={3} />
}

DeviceModelMessagesPage.getLayout = (page) => (
  <DefaultLayout>
    <DeviceModelLayout>{page}</DeviceModelLayout>
  </DefaultLayout>
)

export default DeviceModelMessagesPage
