...
const DeviceModelProtocolPage: NextPageWithLayout = () => {
  const { id } = useParams()
  ...
  return (
    <DeviceModelEditorTabs modelId={modelId} activeStep={0} />
  )
}

DeviceModelProtocolPage.getLayout = (page) => (
  <DefaultLayout>
    <DeviceModelLayout>{page}</DeviceModelLayout>
  </DefaultLayout>
)

export default DeviceModelProtocolPage
