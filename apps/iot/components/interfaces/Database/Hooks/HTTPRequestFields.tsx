    ...
    <>
      ...
      >
        <FormSectionContent loading={false} className="lg:!col-span-8">
          <SelectField id="http_method" name="http_method" size="medium" label="Method">
            <SelectField.Option id="GET" value="GET" label="GET">
              GET
            </SelectField.Option>
            <SelectField.Option id="POST" value="POST" label="POST">
              POST
            </SelectField.Option>
          </SelectField>
          {type === 'http_request' ? (
            ...
            <SelectField id="http_url" name="http_url" label="Select which edge function to trigger">
              {edgeFunctions.map((fn) => {
                ...
                return (
                  <SelectField.Option key={fn.id} id={functionUrl} value={functionUrl} label={fn.name}>
                    {fn.name}
                  </SelectField.Option>
                )
              })}
