...
import { Button, Form, Input, SelectField, Modal } from 'ui'
          ...
          <>
            <Modal.Content>
              ...
              <div className="flex items-center space-x-2">
                ...
                <SelectField id="units" className="w-[150px]">
                  <SelectField.Option id="days" label="days" value="days">
                    days
                  </SelectField.Option>
                  <SelectField.Option id="weeks" label="weeks" value="weeks">
                    weeks
                  </SelectField.Option>
                  <SelectField.Option id="months" label="months" value="months">
                    months
                  </SelectField.Option>
                  <SelectField.Option id="years" label="years" value="years">
                    years
                  </SelectField.Option>
                </SelectField>
              </div>
