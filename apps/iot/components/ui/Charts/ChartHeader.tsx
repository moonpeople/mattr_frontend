...
import { cn, PopoverContent_Shadcn_, PopoverTrigger_Shadcn_, Popover_Shadcn_ } from 'ui'
        ...
        {titlePopover && (
          <Popover_Shadcn_>
            <PopoverTrigger_Shadcn_ asChild>
              <button
                type="button"
                className="flex h-4 w-4 items-center justify-center text-foreground-lighter transition-colors hover:text-foreground"
              >
                <InfoIcon className="h-4 w-4" />
              </button>
            </PopoverTrigger_Shadcn_>
            <PopoverContent_Shadcn_ align="start" className="w-64 text-xs">
              {titlePopover}
