...
import { PLATFORM_PROJECT_TYPE, PROVIDERS } from 'lib/constants'
...
export async function createProject({
  ...
  const body: CreateProjectBody & { project_type?: 'base' } = {
    ...
    ...(PLATFORM_PROJECT_TYPE ? { project_type: PLATFORM_PROJECT_TYPE as 'base' } : {}),
  }
