...
export async function getModel({
  ...
  if (preferredProvider === 'openai') {
    ...
    const openaiModel = useOpenAIChatCompat
      ? openaiProvider.chat(chosenModelId as OpenAIModel)
      : openaiProvider(chosenModelId as OpenAIModel)
    return {
      model: openaiModel,
