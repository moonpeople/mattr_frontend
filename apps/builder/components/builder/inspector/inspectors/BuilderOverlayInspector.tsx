/**
 * Инспектор overlay-frame (drawer/modal): настройки overlay-поведения и отображения.
 */
...
type BuilderOverlayInspectorProps = {
  ...
  mode: 'drawer' | 'modal'
  widgetMode: 'app-frame' | 'page-frame'
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto px-4 py-3">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Button type="text" size="tiny" className="px-1" icon={<Plus size={14} />} />
            </div>
