        ...
        {isSuccess && (
          <div className="space-y-4">
            {currentBillingCycleSelected &&
              ...
              hasProjectsExceedingDiskSize && (
                <Alert_Shadcn_ variant="warning">
                  ...
                  <AlertDescription_Shadcn_>
                    You have projects that are exceeding 8 GB of provisioned disk size. Reduce the
                    disk size or contact support to review your plan limits.
                  </AlertDescription_Shadcn_>
                </Alert_Shadcn_>
              )}
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                <p className="text-xs text-foreground-light">Over limit in period</p>
                <p className="text-xs">
              ...
              <Panel>
                <Panel.Content>
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm text-foreground-light">
                      Switch to the current period to see current disk size per project.
                    </p>
                  </div>
                </Panel.Content>
              </Panel>
