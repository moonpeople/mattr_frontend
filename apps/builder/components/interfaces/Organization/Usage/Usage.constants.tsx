...
const USAGE_APPROACHING_THRESHOLD = 0.8
...
export const USAGE_CATEGORIES: (subscription?: OrgSubscription) => CategoryMeta[] = (
  ...
  const egressAttributes: CategoryAttribute[] = [
    {
      ...
      unit: 'bytes',
      description:
        'Contains any outgoing traffic including Database, Storage, Realtime, Auth, API, Edge Functions, Pooler and Log Drains.\nUsage is based on the total sum of uncached egress in GB throughout the selected period.\nCached egress is tracked separately.',
      chartDescription:
  ...
  if (subscription?.plan.id === 'free') {
                ...
                <div className="flex w-full items-center flex-col justify-center space-y-2 md:flex-row md:justify-between">
                  <div>
                    ...
                    {onFreePlan
                      ...
                      : 'Contact support to review your plan limits.'}
                  </div>
                </div>
              </Admonition>
            )}
    ...
    databaseAndStorageSizeAttributes.push({
      ...
      unit: 'bytes',
      description:
        "Each Supabase project comes with a dedicated disk. Each project includes 8 GB of disk. Disk automatically scales up when you get close to its size.\nDisk usage is reported in GB-Hrs over the selected period.",
      links: [
        {
          name: 'Documentation',
      ...
      attributes: [
        {
          ...
          chartPrefix: 'Cumulative',
          chartSuffix: 'in current period',
          unit: 'absolute',
          description:
            'Users who log in or refresh their token count towards MAU.\nUsage is based on the sum of distinct users requesting your API during the selected period. Resets each period.',
          chartDescription:
            'The data is refreshed over a period of 24 hours and resets at the beginning of each period.\nThe data points are relative to the beginning of your selected period and will reset with your period.',
          links: [
            {
              name: 'Auth',
        ...
        },
        {
          ...
          unit: 'absolute',
          description:
            'SSO users who log in or refresh their token count towards SSO MAU.\nUsage is based on the sum of distinct Single Sign-On users requesting your API during the selected period. Resets each period.',
          chartDescription:
            'The data refreshes over a period of 24 hours and resets at the beginning of each period.\nThe data points are relative to the beginning of your selected period and will reset with your period.',
          links: [
            {
        ...
        },
        {
          ...
          unit: 'absolute',
          description:
            'We count all images that were transformed in the selected period, ignoring any transformations.\nUsage example: You transform one image with four different size transformations and another image with just a single transformation. It counts as two, as only two images were transformed.\nUsage is based on the count of (origin) images that used transformations throughout the selected period. Resets each period.',
          chartDescription:
        ...
        },
        {
          ...
          unit: 'absolute',
          description:
            'Total number of successful connections. Connections attempts are not counted towards usage.\nUsage is based on the maximum amount of concurrent peak connections during the selected period.',
          chartDescription: 'The data refreshes every hour.',
          links: [
            {
              name: 'Realtime Quotas',
