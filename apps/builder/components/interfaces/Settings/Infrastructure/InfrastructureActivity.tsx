            ...
            <ScaffoldContainer id={attribute.anchor}>
              <ScaffoldSection>
                ...
                <ScaffoldSectionContent>
                  ...
                  {attribute.key === 'max_cpu_usage' && projectResourceWarnings?.cpu_exhaustion && (
                    <Admonition type="warning" title="High CPU usage detected">
                      <p className="text-sm">
                        Consider reducing load or scaling compute to avoid performance issues.
                      </p>
                    </Admonition>
                  )}
                  {attribute.key === 'ram_usage' &&
                    projectResourceWarnings?.memory_and_swap_exhaustion && (
                      <Admonition type="warning" title="High memory usage detected">
                        <p className="text-sm">
                          Consider reducing load or scaling compute to avoid performance issues.
                        </p>
                      </Admonition>
