          ...
          <Command_Shadcn_>
            ...
            <CommandList_Shadcn_>
              ...
              <CommandGroup_Shadcn_>
                <CommandItem_Shadcn_
                  className="cursor-pointer w-full"
                  onSelect={() => navigateToPortal('/organizations')}
                >
                  <a href="/organizations" className="flex items-center gap-2 w-full">
              ...
              {organizationCreationEnabled && (
                <>
                  ...
                  <CommandGroup_Shadcn_>
                    <CommandItem_Shadcn_
                      className="cursor-pointer w-full"
                      onSelect={() => navigateToPortal('/new')}
                    >
                      <a href="/new" className="flex items-center gap-2 w-full">
