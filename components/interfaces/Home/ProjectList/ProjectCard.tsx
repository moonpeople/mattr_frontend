...
import { getProjectHref, getProjectType } from 'lib/project-links'
...
export const ProjectCard = ({
  ...
  const projectHref = getProjectHref(project as any)
  const isIotProject = getProjectType(project as any) === 'iot'
  const resolvedHref = rewriteHref ? rewriteHref : projectHref
  ...
  return (
    <li className="list-none h-min">
      <CardButton
        linkHref={isIotProject ? undefined : resolvedHref}
        url={isIotProject ? resolvedHref : undefined}
        ...
        containerElement={
          isIotProject ? undefined : (
            <ProjectIndexPageLink href={resolvedHref} projectRef={projectRef} />
          )
        }
      />
    </li>
