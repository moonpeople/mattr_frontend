            ...
            className={cn(
              ...
              // Today indicator styles
                ...
                cn(
                  ...
                  isRange
                    ? 'data-selection-end:after:bg-card data-selection-start:after:bg-card'
                    : 'data-selected:after:bg-card',
                ),
            )}
            date={date}
          />
...
function Calendar({ className, ...props }: CalendarProps) {
  return (
    <CalendarRac
      {...props}
      className={composeRenderProps(className ?? '', (className: string) => cn('w-fit', className))}
    >
      <CalendarHeader />
